...
namespace VoyageForge.ForgeCLR.Editor
{
    ...
    /// </summary>
    public sealed class HotUpdateDllABCollectionCheck : IForgeCLRValidationCheck<HCLRRuntimeConfigSO>
    {
        ...
        public ForgeCLRValidationItem Validate(ForgeCLRValidationContext context, HCLRRuntimeConfigSO config)
        {
            ...
            var exists = config != null && HasCollectorForPath(runtimeSettings, context.CollectorSetting,
                config.HotUpdateDllCopyDirectory);
