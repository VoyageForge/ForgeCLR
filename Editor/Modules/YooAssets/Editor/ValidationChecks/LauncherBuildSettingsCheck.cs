...
namespace VoyageForge.ForgeCLR.Editor
{
    ...
    /// </summary>
    public sealed class LauncherBuildSettingsCheck : IForgeCLRValidationCheck<YooAssetsRuntimeConfigSO>
    {
        ...
        {
            var location = config?.LauncherSceneLocation ?? context.Settings.LauncherSceneLocation;
